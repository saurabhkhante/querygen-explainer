function A2Poster() {
  return (
    <div className="w-[420mm] h-[594mm] bg-[#075E54] flex flex-col items-center p-24 print:p-16 relative overflow-hidden" style={{paddingTop: '140px'}}>
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#128C7E] rounded-full blur-3xl opacity-20 print:hidden"></div>
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#25D366] rounded-full blur-3xl opacity-15 print:hidden"></div>
