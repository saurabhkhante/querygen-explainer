  ...
  return (
    <div className="min-h-screen bg-[#075E54] relative overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-12 max-w-6xl">
        <div className="text-[60px] text-white leading-tight font-light tracking-wide mb-8">
          Send one message to <span className="font-black text-[68px]">200 people</span>.
        </div>
        <div className="text-[76px] text-white font-black leading-tight tracking-tight">
