...
const SLIDES = [
  {
    id: 'cover',
    type: 'section',
    title: 'Querygen × Red Lotus Pharmtech',
    subtitle: 'A conversation about AI in pharma.',
  },
  {
    id: 'what-we-do',
    type: 'whatwedo',
  ...
  },
  {
    ...
    subtitle: 'One thing we\'ve already built. A few ideas we\'re exploring.',
  },
  {
    id: 'nichem-origin',
    type: 'pharma-scene',
    ...
    bullets: [
      ...
      'This got us thinking: the same pattern applies to pharma. API grades, DMF filings, CoA requests, multilingual buyer queries.',
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      'We\'re actively exploring this for pharma manufacturers. Nichem showed us it works in specialty chemicals.',
    ],
    footnote: 'A version of this could also work for consulting practices — trained on your protocols, SOPs, and methodology.',
  },
  {
    id: 'opportunity',
    type: 'standard',
    title: 'Where Else We See the Opportunity',
    subtitle: 'Patterns we\'ve already built in other industries — each maps directly to a pharma use case.',
    bullets: [
  ...
  },
  {
    ...
    subtitle: 'You know pharma operations from the inside. We know what\'s technically possible.',
    points: [
      'Which of these patterns resonates most with what you see in the field?',
      'Where does the real operational pain sit — floor ops, compliance, BD, something else?',
      'Is there a workflow or a client problem that immediately comes to mind?',
    ],
    offer: 'We could build something for **your own team first** — a bot trained on your methodology, protocols, and service docs. Your consultants use it in client meetings. You see it work before recommending it to anyone.',
  },
  {
    id: 'thankyou',
    type: 'thankyou',
...
export default function RedLotusDeck() {
  ...
  useEffect(() => {
    ...
    document.title = 'AI + Pharma Operations | Querygen × Red Lotus Pharmtech';
  ...
  return (
    <div className="min-h-screen bg-[#F7F5F2] text-[#1E1E1E]">
      ...
      <div className="pointer-events-none fixed top-4 left-6 right-16 sm:top-6 sm:left-10 sm:right-24 z-30 flex items-center justify-between">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#D7D0C8] bg-white/80 backdrop-blur-sm">
          <span className="w-2 h-2 rounded-full bg-[#8B1A1A] shrink-0" />
          <span className="text-xs sm:text-sm font-medium text-[#4A1A1A] tracking-wide">Red Lotus Pharmtech</span>
        </div>
      </div>
