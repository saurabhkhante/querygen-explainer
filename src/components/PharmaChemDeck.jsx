      ...
      <div className="max-w-5xl">
        ...
        {slide.offer && (
          <div className="mt-4 rounded-2xl border border-[#D7D0C8] border-l-4 border-l-[#1A8A4A] bg-white/80 px-5 py-5 shadow-[0_4px_16px_rgba(44,38,30,0.06)]">
            <p className="text-xs uppercase tracking-wider text-[#1A8A4A] mb-2">How we typically start</p>
...
const SLIDES = [
  {
    id: 'cover',
    type: 'section',
    title: 'AI for Pharma & Chemical Operations',
    subtitle: 'Dashboards, bots, and automations built around data your team already creates.',
  },
  {
    id: 'what-we-do',
    type: 'whatwedo',
  ...
  },
  {
    ...
    subtitle: 'Six case studies across manufacturing, chemicals, and field operations. Click any to open the full explainer.',
    cases: [
      {
  ...
  },
  {
    id: 'industry-angle',
    type: 'section',
    title: 'Where We Already Fit',
    subtitle: 'One live proof of concept in specialty chemicals. Patterns that repeat across chemicals and pharma.',
  },
  {
    id: 'nichem-origin',
    type: 'pharma-scene',
    ...
    subtitle: 'Nichem Chemicals — a specialty chemical distributor — already runs a bot like this on WhatsApp and their website.',
    bullets: [
      '240+ SKUs, 10+ languages. International buyers ask product, regulatory, and compliance questions 24/7 — the bot answers from Nichem\'s own data.',
      'The same pattern applies across the board: API manufacturers, specialty chemical exporters, industrial distributors — anyone with a product catalog and international buyers.',
    ],
    ctaLabel: 'Open Nichem Explainer',
    ctaHref: '/nichem-explainer',
  },
  {
    id: 'specbot',
    type: 'standard',
    title: 'SpecBot — A Multilingual Product Expert',
    subtitle: 'Trained on your catalog, SDS sheets, TDS, DMF filings, and certificates. Answers buyers in any language, any time.',
    bullets: [
      '**A German procurement officer** asks about product grade, REACH compliance, and packaging at 11pm — answered immediately with the right specs.',
      '**A Korean API buyer** asks in Korean — SpecBot responds from your English-only documents with full technical details.',
      '**A specialty chemical buyer** asks for TDS, CoA, and UN transport classification — pulled from your files in seconds.',
      '**When buying intent appears**, the bot captures company, product, quantity, and target market — and routes a structured lead to your BD team.',
      '**Your sales team** can pull exact specs, certifications, and grade options mid-customer-call — no putting anyone on hold.',
      'Works for pharma API manufacturers, specialty chemical exporters, industrial chemical distributors, and ingredient suppliers alike.',
    ],
  },
  {
    id: 'opportunity',
    type: 'standard',
    title: 'The Broader Opportunity',
    subtitle: 'Patterns we\'ve built in other industries — each maps directly to chemical or pharma manufacturing operations.',
    bullets: [
      '**Batch costing** — yield and raw material consumption flow into a cost sheet the moment a batch closes. No re-entry across ERP, finance, or planning.',
      '**Safety and training compliance** — certifications tracked automatically, gaps surfaced before an audit. No manual chasing.',
      '**Plant and field audit reporting** — shift notes and inspection findings become a structured log visible to management in real time.',
      '**Export and customer documentation** — CoA, SDS, and compliance certificates pulled and packaged per buyer requirement. No last-minute scramble.',
      '**Dispatch and logistics coordination** — production complete → transporter, warehouse, and customer notified automatically. No manual handoffs.',
      '**Change control and deviations** — a formulation or process change triggers a routed approval, then links back to batch records and training automatically.',
    ],
  },
  {
    id: 'explore',
    ...
    subtitle: 'Every engagement starts with a real workflow — something your team does today that we can make faster, cleaner, or automatic.',
    points: [
      'Which of these patterns maps most directly to what your team does today?',
      'Where does the most data get lost or re-entered manually?',
      'Is there a compliance or operations workflow that immediately comes to mind?',
    ],
    offer: 'We typically start with **one workflow or one document set** — a bot trained on your SOPs and product data, or a dashboard built from your existing reports. You see it working in 2 weeks.',
  },
  {
    id: 'thankyou',
    type: 'thankyou',
...
export default function PharmaChemDeck() {
  ...
  useEffect(() => {
    ...
    document.title = 'AI for Pharma & Chemical Operations | Querygen';
  ...
  return (
    <div className="min-h-screen bg-[#F7F5F2] text-[#1E1E1E]">
      ...
      <div className="pointer-events-none fixed top-4 left-6 right-16 sm:top-6 sm:left-10 sm:right-24 z-30 flex items-center justify-between">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[#C5DDD5] bg-white/80 backdrop-blur-sm">
          <span className="w-2 h-2 rounded-full bg-[#0D7A5F] shrink-0" />
          <span className="text-xs sm:text-sm font-medium text-[#0A5040] tracking-wide">Pharma &amp; Chemicals</span>
        </div>
      </div>
