...
const SLIDES = [
  ...
  },
  {
    id: 'pharma-angle',
    type: 'section',
    title: 'The Pharma Angle',
    subtitle: 'One thing we\'ve already built. A few patterns we see clearly.',
  },
  {
    id: 'nichem-origin',
    type: 'pharma-scene',
    ...
    bullets: [
      '240+ SKUs, 10+ languages. Buyers ask product and regulatory questions 24/7 — the bot answers from Nichem\'s own data.',
      'The same pattern applies directly to pharma. API grades, DMF filings, CoA requests, multilingual buyer queries.',
    ],
  ...
  },
  {
    id: 'pharmbot',
    type: 'standard',
    title: 'PharmBot — A Multilingual Product Expert for Pharma',
    subtitle: 'Trained on your catalog, SDS sheets, DMF status, and regulatory docs. Answers buyers instantly, in their language.',
    bullets: [
      '**A German API buyer** asks about pharmacopeia grade and US-DMF status at 11pm — answered immediately with the right specs.',
      '**A Korean procurement officer** asks in Korean — the bot answers from your English-only source documents.',
      '**When buying intent appears**, the bot captures company, molecule, quantity, and regulatory market — and routes a structured lead to BD.',
      '**Your BD team** can pull exact specs, DMF status, and packaging options mid-customer-call — no putting anyone on hold.',
      '**Regulatory team** asks "Is our DMF filed for this molecule in the EU?" — answered from your own records in seconds.',
      'Nichem showed us this works in specialty chemicals. The pharma version is the natural next step.',
    ],
  },
  {
    id: 'opportunity',
    type: 'standard',
    title: 'Where Else We See the Opportunity',
    subtitle: 'Patterns we\'ve already built in other industries — each maps directly to a pharma or chemical manufacturing use case.',
    bullets: [
      '**Training compliance** — attendance gaps flagged automatically. No one chases records manually.',
      '**Field audit reporting** — inspector notes become a structured log, visible to management in real time.',
      '**No deviation falls through the cracks** — flagged informally, tracked formally, closed properly.',
      '**Dispatch coordination** — batch released by QA → logistics, transporter, and customer notified automatically. No calls, no manual paperwork.',
      '**Batch costing** — yield and material consumption flow into a cost sheet as soon as the batch closes. No re-entry into finance trackers.',
      '**Change control** — a process or SOP change triggers a routed approval workflow, then links back to training records automatically.',
    ],
  },
  {
    id: 'explore',
